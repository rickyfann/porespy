...
class SimulationsTest:
    def setup_class(self):
        ...
        self.im = ps.generators.blobs(
            shape=[100, 100, 100], blobiness=2, seed=0, porosity=0.499829
        )
    ...
    def test_gdd_dataframe(self):
        ...
        np.testing.assert_array_almost_equal(
            ...
            np.array(
                [
                    1.329061, 1.288042, 1.411449, 1.273172, 1.46565, 1.294553, 1.553851,
                    1.299077, 1.417645, 1.332902, 1.365739, 1.37725, 1.408786, 1.279847,
                    1.365632, 1.31547, 1.425769, 1.417447, 1.399028, 1.262936, 1.311554,
                    1.447341, 1.504881, 1.196132, 1.508335, 1.273323, 1.361239, 1.334868,
                    1.443466, 1.328017, 1.564574, 1.264049, 1.504227, 1.471079, 1.366275,
                    1.349767, 1.473522, 1.34229, 1.258255, 1.266575, 1.488935, 1.260175,
                    1.471782, 1.295077, 1.463962, 1.494004, 1.551485, 1.363379, 1.474238,
                    1.311737, 1.483244, 1.287134, 1.735833, 1.38633
                ]
            ),
            decimal=4,
        )  # fmt: off
