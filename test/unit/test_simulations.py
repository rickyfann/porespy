...
class SimulationsTest():
    ...
    def test_gdd(self):
        ...
        np.testing.assert_approx_equal(res[0], 1.707800753372152, significant=5)
        np.testing.assert_approx_equal(res[1], 1.7033469726308779, significant=5)
        np.testing.assert_approx_equal(res[2], 1.5911705426959204, significant=5)
